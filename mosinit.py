'''
Current clamp demo using Allen Brain's model 473871592.
...
from neuron473871592 import Neuron473871592
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473871592(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473871592; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-85.204750061)
        h.fcurrent()
